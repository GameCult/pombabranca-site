...
\setlist[itemize]{leftmargin=*,itemsep=0.12em,topsep=0.25em}
\setlist[enumerate]{leftmargin=*,itemsep=0.12em,topsep=0.25em}
\renewcommand{\familydefault}{\sfdefault}
\linespread{0.98}
\pagestyle{plain}

\newcommand{\sectionrule}{\vspace{-0.45em}{\color{PombaBlue}\hrule height 0.8pt}\vspace{0.55em}}
